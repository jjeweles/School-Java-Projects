...
public class PlayWithNumbers {
	...
	enum IceCream {
		chocolate, vanilla, strawberry, cream_in_cookies, neopolitan, banana_nut
	};
	...
	public static void main(String[] args) {
		...
		String valueText;
		String name = "Justin Jewell"; // replace with your name
		...
		System.out.println("Your eanings are: " + fmt1.format(earnings));
	...
	static double getHours() {
		...
		hoursText = JOptionPane.showInputDialog(null, "Please enter the amount of hours you worked this week\n"
				+ "Assume you will earn $25.25 per hour and there is " + "no overtime.");
	...
	static int contributeToCharity() {
		...
		answer = JOptionPane.showConfirmDialog(null, "Would you like to donate 3% of your earnings to a charity?",
				"Charity question", JOptionPane.YES_NO_OPTION);
		return answer;
	...
	static void determinePay(int answer, double earnings) {
		...
		if (answer == YES) {
			...
			System.out.println("With " + fmt2.format(CHARITY) + " charity deductions, " + "your earnings are: "
			...
			switch (type) {
			case 0:
				typeIceCream = IceCream.chocolate;
				break;
			case 1:
				typeIceCream = IceCream.vanilla;
				break;
			case 2:
				typeIceCream = IceCream.strawberry;
				break;
			case 3:
				typeIceCream = IceCream.cream_in_cookies;
				break;
			case 4:
				typeIceCream = IceCream.neopolitan;
				break;
			case 5:
				typeIceCream = IceCream.banana_nut;
				break;
			default:
				System.out.println("Error in type of ice cream!");
				System.exit(0);
		...
		// user will NOT contribute to a charity
			...
			System.out.println("With *no* charity deductions your earnings are: " + fmt1.format(earnings)
					+ ", no ice cream for you! :(");
		} else // an error occurred here
		{
			JOptionPane.showMessageDialog(null, "Error! Invalid value.", "Invalid input", JOptionPane.ERROR_MESSAGE);
		}

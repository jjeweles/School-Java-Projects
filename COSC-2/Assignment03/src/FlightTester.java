...
public class FlightTester {
	...
	public static void main(String[] args) throws Exception {
		...
		while (fromFile.hasNext()) // read info from file until done
		{
		...
		airline = JOptionPane.showInputDialog(null, "Please enter new airline: ");
		origin = JOptionPane.showInputDialog(null, "Please enter new origin: ");
		destination = JOptionPane.showInputDialog(null, "Please enter new destination: ");
		flightNumberText = JOptionPane.showInputDialog(null, "Please enter new flight number: ");
		flightNumber = Integer.parseInt(flightNumberText);
